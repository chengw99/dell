# -*- coding: utf-8 -*-
"""
Created on Tue Jul 17 17:53:45 2018

@author: DELL
"""

# 数据要求是导出的Excel内含多个工作表
# 此程序用于批量拼接红外温度数据,中空模型，不同日期-- 20170511
...
date = ['201705'+str(i) for i in range(11,12)]
for d in date:
    ipath = r'E:\py_data\hongwai'+'\\'+d
    opath = r'e:\py_output'
    k = ['one-facing north','two-facing north',
         'one-facing south','two-facing south',]
