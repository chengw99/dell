# -*- coding: utf-8 -*-
"""
Created on Mon Apr 23 09:36:37 2018

@author: DELL
"""

#此程序用于分析不同高宽比的街谷空气温度 -6月份
import os
import glob
import shutil
import numpy as np
...
for v in vfile:
    ...
    for b in bfile:
        ...
        for bb in bbfile:
            ...
            dict = {'1':'10cm','2':'30cm','3':'60cm','4':'90cm','5':'144cm','6':'144cm-north','7':'144cm-south'}
            if len(cc) == 3:
                if b == 'empty':
                ...
                plt.close()
#--------------------------移动结果到最终文件夹-----------------------------------#                
kpath = r'C:\Users\DELL\Desktop\处理数据\picture\ibutton\10min平均\6月份\对比不同高宽比'
