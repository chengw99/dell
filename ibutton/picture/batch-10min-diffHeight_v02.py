# -*- coding: utf-8 -*-
"""
Created on Fri Apr 20 16:53:54 2018
...
spath = r'C:\Users\DELL\Desktop\处理数据\按日期排序\ibutton\6月份'
...
for g in gfile:
    ...
    for z in zfile:
        ...
        if len(cfile) == 7:
            ...
            data4 = pd.read_csv(cfile[3]) # 90cm
            data5 = pd.read_csv(cfile[4]) # 144cm
            data6 = pd.read_csv(cfile[5]) # 144cm-N
            data7 = pd.read_csv(cfile[6]) # 144cm-S
            ...
            plt.plot(x,y4,linestyle='-',marker='s',markersize=5,markerfacecolor='none',markevery=6,linewidth=0.8,label=z+'-'+r'h=0.9m-'+g)
            plt.plot(x,y5,linestyle='-',marker='x',markersize=5,markerfacecolor='none',markevery=6,linewidth=0.8,label=z+'-'+r'h=1.44m-'+g)
            #plt.plot(x,y6,linestyle='-',marker='^',markersize=5,markerfacecolor='none',markevery=6,linewidth=0.8,label=z+'-'+r'h=1.44m-north-'+g)
            #plt.plot(x,y7,linestyle='-',marker='>',markersize=5,markerfacecolor='none',markevery=6,linewidth=0.8,label=z+'-'+r'h=1.44m-south-'+g)
        ...
        if len(cfile) == 6:
            ...
            plt.plot(x,y2,linestyle='-',marker='o',markersize=5,markerfacecolor='none',markevery=6,linewidth=0.8,label=z+'-'+r'h=0.3m-'+g)
            plt.plot(x,y3,linestyle='-',marker='v',markersize=5,markerfacecolor='none',markevery=6,linewidth=0.8,label=z+'-'+r'h=0.6m-'+g)
            plt.plot(x,y4,linestyle='-',marker='x',markersize=5,markerfacecolor='none',markevery=6,linewidth=0.8,label=z+'-'+r'h=0.9m-'+g)
            plt.plot(x,y5,linestyle='-',marker='^',markersize=5,markerfacecolor='none',markevery=6,linewidth=0.8,label=z+'-'+r'h=1.44m-north-'+g)
            #plt.plot(x,y6,linestyle='-',marker='>',markersize=5,markerfacecolor='none',markevery=6,linewidth=0.8,label=z+'-'+r'h=1.44m-north-'+g)
            ...
            plt.close()
#--------------------------移动结果到最终文件夹-----------------------------------#                
kpath = r'C:\Users\DELL\Desktop\处理数据\picture\ibutton\10min平均\6月份\对比不同高度'
