# -*- coding: utf-8 -*-
"""
Created on Mon Apr  9 09:43:51 2018
...
for i in l:
    ...
    for d in dfile:
        ...
        if len(sfile) == 4:
            ...
            plt.plot(x,y1,marker = 'D',markersize = 0.5,linewidth = 1,label = sfile[1][:-4])
            plt.plot(x,y2,marker = 's',markersize = 0.5,linewidth = 1,label = sfile[2][:-4])
            plt.plot(x,y3,marker = '^',markersize = 0.5,linewidth = 1,label = sfile[3][:-4])
            plt.plot(x,y4,marker = 'v',markersize = 0.5,linewidth = 1,label = sfile[0][:-4])
